...
class TestHaroAPIClient(TestCase):
    ...
    def test_all_predictions(self, m):
        ...
        r1, r2, r3 = results
        self.assertEqual(r1.pid, "rank-items-for-action-watch")
        self.assertEqual(r1.name, "rank-watch")
        self.assertEqual(r1.entities, ['item-3', 'item-1', 'item-2'])
        self.assertEqual(r1.scores, [0.79, 0.43, 0.05])
        self.assertEqual(r2.pid, "predict-avg-context-for-action-watch-context-duration_seconds")
        self.assertEqual(r2.name, "avg-duration")
        self.assertEqual(r2.value, 31.41)
        self.assertEqual(r3.pid, "anticipate-condition-eebc14df57-within-3-hours")
        self.assertEqual(r3.name, "anticipate-watch")
        self.assertEqual(r3.value, 0.79)
